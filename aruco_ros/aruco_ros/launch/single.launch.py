...
def launch_setup(context, *args, **kwargs):
    ...
    aruco_single = Node(
        ...
        remappings=[("/camera_info", "/mechmind/camera_info"), ("/image", "/mechmind/color_image")],
    )
...
def generate_launch_description():
    ...
    marker_id_arg = DeclareLaunchArgument(
        "marker_id", default_value="24", description="Marker ID. "
    )

    marker_size_arg = DeclareLaunchArgument(
        "marker_size", default_value="0.15", description="Marker size in m. "
    )
